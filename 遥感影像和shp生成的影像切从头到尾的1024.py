...
while (i + cell < im_height):
    ...
    while (j + cell < im_width):
        ...
        cv2.imwrite(os.path.join(output_folder, 'duxiang_uav_{0}_{1}.png'.format(i, j)), image)
        cv2.imwrite(os.path.join(output_folder_mask, 'duxiang_uav_{0}_{1}.png'.format(i, j)), out_bandmask)
