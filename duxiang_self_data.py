...
shp_path = r"H:\xzr\duxiang_buffer\real-huapo\shp\2019projected.shp"  # shp文件的路径， shapefile不支持中文路径
...
for i in range(len(shapes)):
    ...
    mask.save(r"H:\xzr\duxiang_buffer\real-huapo\mask\real0729-"+ str(i) + '.png')
    ...
    img = Image.open(out_dir + str(i) + '.tif')
    img.save(r"H:\xzr\duxiang_buffer\real-huapo\image\real0729-"+ str(i) + '.png')
