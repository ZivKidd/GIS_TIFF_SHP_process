...
# shp_path = r"I:\slope\bengta_dem.shp" # shp文件的路径， shapefile不支持中文路径
# print(shp_path)
# # cell = 3000
...
tif_files=[r"I:\duxiang_slope\都香DSM3米\slope0.tif","I:\duxiang_slope\都香DSM3米\slope1.tif",
           "I:\duxiang_slope\都香DSM3米\slope2.tif","I:\duxiang_slope\都香DSM3米\slope3.tif",]
...
for tif_file in tif_files:
    ...
    out_band1 = in_band1.ReadAsArray(0,0,im_width,im_height)
    out_band1=out_band1[np.where(out_band1>0)]
    out_band1=out_band1[np.where(out_band1<90)]

    # out_band1=np.isnan(out_band1)

    cucao=1/(np.cos(out_band1*3.1415926/180.0))
    print(np.mean(cucao))
